...
import { Users, Download, Calendar as CalendarIcon, Loader2, Search, ArrowLeft } from "lucide-react"
...
function CustomersReportContent() {
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      const url = new URL(`${process.env.NEXT_PUBLIC_API_URL || "http://localhost:5001"}/reports/customers/details`)
    ...
    <div className="p-6 space-y-6 animate-fade-in">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="space-y-1">
            ...
            <p className="text-sm text-muted-foreground">
              Danh sách chi tiết lượng khách hàng đổ về các chi nhánh.
            </p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
            <div className="space-y-2">
              ...
              <Select value={branchID} onValueChange={setBranchID}>
                <SelectTrigger className="rounded-xl border-none bg-slate-100 h-11 focus:ring-1 focus:ring-emerald-500 text-black shadow-inner shadow-slate-200">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-9 rounded-xl border-none bg-slate-100 h-11 focus:ring-1 focus:ring-emerald-500 text-black shadow-inner shadow-slate-200"
                />
              </div>
            </div>
            ...
            <Button 
              className="h-11 rounded-xl font-bold bg-emerald-600 hover:bg-emerald-700 shadow-lg shadow-emerald-500/20 gap-2 transition-all active:scale-95"
      ...
      <Card className="glass border-none shadow-xl rounded-2xl overflow-hidden mt-6">
        <CardHeader className="p-6 pb-2 border-b border-slate-50">
          <CardTitle className="text-lg">Dữ liệu Khách hàng</CardTitle>
          <CardDescription className="text-xs">Database đồng bộ hệ thống VTTech CRM.</CardDescription>
        </CardHeader>
...
export default function CustomersReportPage() {
  return (
    <Suspense fallback={<div className="p-6 flex justify-center mt-20"><Loader2 className="w-8 h-8 animate-spin text-emerald-500" /></div>}>
