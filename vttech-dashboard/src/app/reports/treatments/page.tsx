...
import { Activity, Download, Calendar as CalendarIcon, Loader2, Search, ArrowLeft } from "lucide-react"
import { useSearchParams, useRouter } from "next/navigation"

function TreatmentsReportContent() {
  ...
  const [data, setData] = useState<TreatmentColumn[]>([])
  ...
  return (
    <div className="p-6 space-y-6 animate-fade-in">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="space-y-1">
            ...
            <p className="text-sm text-muted-foreground">
              Tra cứu hồ sơ điều trị, phân bổ thời gian và thông tin bác sĩ theo chi nhánh.
            </p>
          </div>
        </div>
      ...
      <Card className="glass border-none shadow-xl rounded-2xl overflow-hidden relative">
        <div className="absolute top-0 w-full h-1 bg-gradient-to-r from-amber-400 to-amber-600" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
            <div className="space-y-2">
              ...
              <Select value={branchID} onValueChange={setBranchID}>
                <SelectTrigger className="rounded-xl border-none bg-slate-100 h-11 focus:ring-1 focus:ring-amber-500 text-black shadow-inner shadow-slate-200">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-9 rounded-xl border-none bg-slate-100 h-11 focus:ring-1 focus:ring-amber-500 text-black shadow-inner shadow-slate-200"
                />
              </div>
            </div>
            ...
            <Button 
              className="h-11 rounded-xl font-bold bg-amber-500 hover:bg-amber-600 text-white shadow-lg shadow-amber-500/20 gap-2 transition-all active:scale-95"
      ...
      <Card className="glass border-none shadow-xl rounded-2xl overflow-hidden mt-6">
        <CardHeader className="p-6 pb-2 border-b border-slate-50">
          <CardTitle className="text-lg">Dữ liệu Điều trị</CardTitle>
          <CardDescription className="text-xs">Dữ liệu lấy từ phân hệ thực hiện dịch vụ (Treatment).</CardDescription>
        </CardHeader>
...
export default function TreatmentsReportPage() {
  return (
    <Suspense fallback={<div className="p-6 flex justify-center mt-20"><Loader2 className="w-8 h-8 animate-spin text-amber-500" /></div>}>
      <TreatmentsReportContent />
    </Suspense>
  )
}
