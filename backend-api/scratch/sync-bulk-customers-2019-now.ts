...
async function main() {
  ...
  console.log(`📊 Đang thực hiện quét toàn bộ lịch sử từ 2019 đến nay trên ${branches.length} chi nhánh...`);
  console.log('='.repeat(80));

  const dateFrom = '2019-01-01';
  const dateTo = new Date().toISOString().split('T')[0]; // Đồng bộ đến ngày hôm nay
  console.log(`📅 Khoảng thời gian: ${dateFrom} -> ${dateTo}`);
  ...
  console.log('\n================================================================================');
  console.log('🎉 HOÀN THẤT ĐỒNG BỘ TOÀN BỘ HỒ SƠ KHÁCH HÀNG 2019-NAY');
